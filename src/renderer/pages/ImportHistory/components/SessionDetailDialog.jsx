...
export default function SessionDetailDialog({ open, session, onClose, onRollback }) {
    ...
    <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
      ...
      <DialogContent>
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={6} sm={3}>
            <Typography variant="body2" color="text.secondary">Tổng dòng</Typography>
            <Typography variant="h6">{session.total_rows}</Typography>
          </Grid>
          <Grid item xs={6} sm={3}>
            <Typography variant="body2" color="text.secondary">Đã thêm</Typography>
            <Typography variant="h6" color="success.main">{session.imported_rows}</Typography>
          </Grid>
          <Grid item xs={6} sm={3}>
            <Typography variant="body2" color="text.secondary">Trùng lặp</Typography>
            <Typography variant="h6" color="warning.main">{session.duplicate_rows}</Typography>
          </Grid>
          <Grid item xs={6} sm={3}>
            <Typography variant="body2" color="text.secondary">Lỗi</Typography>
            <Typography variant="h6" color="error.main">{session.failed_rows}</Typography>
          </Grid>
