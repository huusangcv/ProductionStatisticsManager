export const DEPARTMENTS = ["Mài", "Cắt"];
...
export const generateMockEmployees = (count = 50) => {
  ...
  const middleNames = ["Thị", "Văn", "Hữu", "Đức", "Minh", "Ngọc", "Hoài", "Quang", "Xuân", "Thanh", "Tuấn", "Hoàng"];
  const lastNames = ["Anh", "Bình", "Cường", "Dũng", "Em", "Phong", "Giang", "Hải", "Hương", "Kiên", "Linh", "Mai", "Nam", "Oanh", "Phương", "Quyên", "Sơn", "Trang", "Uyên", "Vinh", "Vy", "Yến"];
...
export const MOCK_EMPLOYEES = generateMockEmployees(120);
