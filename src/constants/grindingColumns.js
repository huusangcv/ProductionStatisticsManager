export const GRINDING_COLUMNS = [
  ...
  { excelHeader: "Đơn đặt hàng của khách hàng客户订单号", databaseField: "customer_order_number", headerName: "Đơn đặt hàng", width: 180 },
  { excelHeader: "Mã công đơn工单号", databaseField: "work_order_number", headerName: "Mã công đơn", width: 150 },
  ...
  { excelHeader: "Số lượng báo phế报废数量", databaseField: "scrap_quantity", headerName: "Số lượng báo phế", width: 160, type: "number" },
